class TeacherPerformanceDictModel {
  List<CommentList> commentList;
  List<CommentList> attendList;

  TeacherPerformanceDictModel({this.commentList, this.attendList});

  TeacherPerformanceDictModel.fromJson(Map<String, dynamic> json) {
