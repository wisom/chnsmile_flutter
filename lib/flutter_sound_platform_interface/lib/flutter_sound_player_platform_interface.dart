...
abstract class FlutterSoundPlayerPlatform extends PlatformInterface {
  ...
  Future<int> openPlayer(FlutterSoundPlayerCallback callback, {Level logLevel, AudioFocus focus, SessionCategory category, SessionMode mode, int audioFlags, AudioDevice device, bool withUI,})
  {
  ...
  Future<int> setSpeed(FlutterSoundPlayerCallback callback, { double speed})
  {
    throw UnimplementedError('invokeMethod() has not been implemented.');
  }
