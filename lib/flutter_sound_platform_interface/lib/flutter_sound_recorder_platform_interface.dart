...
abstract class FlutterSoundRecorderPlatform extends PlatformInterface {
  ...
  Future<void> openRecorder(FlutterSoundRecorderCallback callback, {Level logLevel, AudioFocus focus, SessionCategory category, SessionMode mode, int audioFlags, AudioDevice device})
  {
