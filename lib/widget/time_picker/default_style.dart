...
class DefaultPickerStyle extends PickerStyle {
  DefaultPickerStyle({bool haveRadius: false, String title}) {
    ...
    if (title != null && title != '') {
      this.title = Center(child: Text(title, style: TextStyle(color: Colors.grey, fontSize: 13)));
    }
  }
  ...
  DefaultPickerStyle.dark({bool haveRadius: false, String title}) {
    ...
    if (title != null && title != '') {
      this.title = Center(child: Text(title, style: TextStyle(color: Colors.white, fontSize: 13)));
    }
  ...
  ClosePickerStyle({bool haveRadius: false, String title}) {
    ...
    if (title != null && title != '') {
      this.title = Padding(
        ...
        child: Align(
            alignment: Alignment.centerLeft, child: Text(title, style: TextStyle(color: Colors.grey, fontSize: 13))),
      );
    }
    this.commitButton = Container(
  ...
  ClosePickerStyle.dark({bool haveRadius: false, String title}) {
    ...
    if (title != null && title != '') {
      this.title = Padding(
        padding: const EdgeInsets.only(left: 16),
        child: Align(
            alignment: Alignment.centerLeft, child: Text(title, style: TextStyle(color: Colors.white, fontSize: 13))),
      );
    }
