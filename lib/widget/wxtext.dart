...
enum WXTextOverflow {clip,fade,ellipsisMiddle,ellipsisEnd,visible,}

class WXText extends Text {
  final String data;
  ...
  final WXTextOverflow wxOverflow;
  ...
  WXText(
      this.data, {
        ...
        this.locale,
        this.softWrap,
        this.wxOverflow = WXTextOverflow.ellipsisMiddle,
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(builder: (_, boxConstraint) {
      return Text(
        wxOverflow !=  WXTextOverflow.ellipsisMiddle ? data : _finalString(boxConstraint.maxWidth, data),
  ...
  TextOverflow _getOverflow(WXTextOverflow overflow) {
    ...
    if (overflow == WXTextOverflow.ellipsisEnd || overflow == WXTextOverflow.ellipsisMiddle) {
      textOverflow = TextOverflow.ellipsis;
    } else if (overflow == WXTextOverflow.clip) {
