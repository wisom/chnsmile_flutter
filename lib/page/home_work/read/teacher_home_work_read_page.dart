import 'package:chnsmile_flutter/page/home_work/read/teacher_home_work_read_tab_page.dart';
...
class TeacherHomeWorkReadPage extends StatefulWidget {
  final Map params;
  String id;
  String classId;
  String className;
  ...
  TeacherHomeWorkReadPage({Key key, this.params}) : super(key: key) {
  ...
  @override
  _TeacherHomeWorkReadPageState createState() => _TeacherHomeWorkReadPageState();
}

class _TeacherHomeWorkReadPageState extends State<TeacherHomeWorkReadPage>
    ...
    return Flexible(
        child: TabBarView(
            ...
            children: _tabs.map((tab) {
              return TeacherHomeWorkReadTabPage(
                  id: widget.id,
